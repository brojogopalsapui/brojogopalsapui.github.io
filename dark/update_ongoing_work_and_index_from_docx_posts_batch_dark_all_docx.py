...
def update_index_html(input_html_path, output_html_path, post_id, title, preview,
    ...
    if update_floating:
        # Support older homepage versions with a floating Research Watch box,
        # newer versions with a research-alert block, and also homepage versions
        # that simply do not include a floating/latest-note component.
